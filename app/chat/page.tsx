          ...
          <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-bold text-gray-900 dark:text-white text-sm">Chat 커맨드 목록</h2>
              </div>
              <button
            ...
            <div className="flex flex-col gap-1.5">
              {([
                { cmd: '/commands',           desc: '사용 가능한 커맨드 목록 표시',   crown: false },
                { cmd: '/leave',              desc: '현재 채팅방 나가기',              crown: false },
                { cmd: '/end',                desc: '지원 채팅방 종료 (Mod 이상)',     crown: false },
                { cmd: '/kick 사용자명',       desc: '사용자를 채팅방에서 강제 퇴장',  crown: true  },
                { cmd: '/announcement 텍스트', desc: '채팅방 공지 설정',               crown: true  },
                { cmd: '/promote 사용자명',    desc: '방장 권한 양도',                 crown: true  },
              ] as const).map(({ cmd, desc, crown }) => (
                <div key={cmd} className="flex items-start gap-3 px-3 py-2.5 rounded-xl bg-gray-50 dark:bg-dark-bg">
                  <code className="text-xs font-bold text-red-primary dark:text-yellow-primary shrink-0 leading-relaxed">
                    {crown ? '👑 ' : ''}{cmd}
                  </code>
